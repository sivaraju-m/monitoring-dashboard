...
class PerformanceReporter:
    ...
    async def generate_daily_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            report = {
                ...
                "recommendations": await self._generate_recommendations(strategy_data, trading_data)
            }
        ...
        try:
            ...
            if strategy_dir.exists():
                ...
                if strategy_files:
                    ...
                    data.update({
                        "active_strategies": len(strategy_data.get("strategies", [])),
    ...
    async def _generate_summary(self, strategy_data: Dict[str, Any], trading_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "win_rate": trading_data.get("winning_trades", 0) / max(trading_data.get("total_trades", 1), 1) * 100,
    ...
    async def _generate_recommendations(self, strategy_data: Dict[str, Any], trading_data: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            if daily_pnl < -5000:
                recommendations.append("Daily P&L is significantly negative. Consider reducing position sizes.")
            
            if win_rate < 40:
                recommendations.append("Win rate is below optimal threshold. Review strategy parameters.")
            
            if total_trades < 10:
                recommendations.append("Low trading activity detected. Check market conditions and strategy triggers.")
